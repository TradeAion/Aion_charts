...
console.log("aion webgpu:  ", JSON.stringify(measure(await setup(p, "http://127.0.0.1:4174/?backend=webgpu", false), 303, 60, 700)));
console.log("aion canvas2d:", JSON.stringify(measure(await setup(p, "http://127.0.0.1:4174/?backend=canvas2d", false), 303, 60, 700)));
console.log("reference:    ", JSON.stringify(measure(await setup(p, "http://127.0.0.1:4174/reference.html?runtimeTest=presentedFrame&backend=canvas2d&dpr=1&spacing=6&theme=light", true), 303, 60, 700)));
await b.close();
