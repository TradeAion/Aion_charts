//! PipelineManager — single rect pipeline for the unified geometry architecture.
//!
//! One pipeline, one shader (rect.wgsl), one instance layout (ColoredRect).
//! The shader trivially draws colored quads at pixel positions.
