...
export class Aion_charts {
     ...
     * ```
     */
    static create_chart(container: any, options: any): Promise<Aion_charts>;
    /**
...
export interface InitOutput {
    ...
    readonly chartworkspace_new: (a: number, b: number) => [number, number, number];
    readonly chartworkspace_pane_host_id: (a: number, b: number) => [number, number];
    readonly chartworkspace_pane_ids: (a: number) => any;
    ...
    readonly chartworkspace_set_on_active_pane_change: (a: number, b: any) => void;
    ...
    readonly chartworkspace_split_active: (a: number, b: number, c: number) => [number, number, number];
    readonly chartworkspace_split_pane: (a: number, b: number, c: number, d: number) => [number, number, number];
    ...
    readonly aion_charts_add_autoscale_contribution: (a: number, b: number, c: number) => [number, number, number];
    readonly aion_charts_add_bar_series: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => number;
    readonly aion_charts_add_baseline_series: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number, w: number, x: number, y: number, z: number, a1: number) => number;
    readonly aion_charts_add_execution_mark: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number, h: number, i: number, j: number) => void;
    readonly aion_charts_add_execution_mark_full: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number) => void;
    readonly aion_charts_add_histogram_series: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly aion_charts_add_indicator_pane: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly aion_charts_add_line_series: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
    readonly aion_charts_add_marker: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => [number, number, number];
    readonly aion_charts_add_marker_at_time: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => [number, number, number];
    readonly aion_charts_allowed_intervals: (a: number) => any;
    readonly aion_charts_append_bar: (a: number, b: bigint, c: number, d: number, e: number, f: number, g: number) => [number, number];
    readonly aion_charts_append_bar_series_point: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number) => [number, number];
    readonly aion_charts_append_bars: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number];
    readonly aion_charts_append_histogram_point: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number, h: number) => [number, number];
    readonly aion_charts_append_series_point: (a: number, b: number, c: bigint, d: number) => [number, number];
    readonly aion_charts_apply_options: (a: number, b: any) => void;
    readonly aion_charts_bar_index_to_timestamp: (a: number, b: number) => bigint;
    readonly aion_charts_begin_selected_drawing_text_edit: (a: number) => number;
    readonly aion_charts_can_add_indicator_pane: (a: number) => number;
    readonly aion_charts_can_load_bar_count: (a: number, b: number) => number;
    readonly aion_charts_can_set_interval: (a: number, b: number, c: number) => number;
    readonly aion_charts_cancel_drawing: (a: number) => void;
    readonly aion_charts_clear_all_markers: (a: number) => void;
    readonly aion_charts_clear_allowed_intervals: (a: number) => void;
    readonly aion_charts_clear_autoscale_contributions: (a: number) => void;
    readonly aion_charts_clear_crosshair: (a: number) => void;
    readonly aion_charts_clear_drawings: (a: number) => void;
    readonly aion_charts_clear_execution_marks: (a: number) => void;
    readonly aion_charts_clear_footprint_data: (a: number) => void;
    readonly aion_charts_clear_markers: (a: number, b: number) => void;
    readonly aion_charts_clear_order_lines: (a: number) => void;
    readonly aion_charts_clear_selected_execution_mark: (a: number) => void;
    readonly aion_charts_complete_drawing: (a: number) => number;
    readonly aion_charts_create_chart: (a: any, b: any) => any;
    readonly aion_charts_create_order_line: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => [number, number];
    readonly aion_charts_create_order_line_full: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number) => [number, number];
    readonly aion_charts_create_price_line: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
    readonly aion_charts_create_study: (a: number, b: number, c: number) => number;
    readonly aion_charts_create_with: (a: number, b: number, c: number, d: number) => any;
    readonly aion_charts_crosshair_mode: (a: number) => [number, number];
    readonly aion_charts_crosshair_state: (a: number) => [number, number];
    readonly aion_charts_data_range: (a: number) => [number, number];
    readonly aion_charts_demo_mode: (a: number) => void;
    readonly aion_charts_demo_mode_footprint: (a: number) => void;
    readonly aion_charts_deselect_drawings: (a: number) => void;
    readonly aion_charts_dispose: (a: number) => void;
    readonly aion_charts_drag_pane_separator: (a: number, b: number, c: number) => void;
    readonly aion_charts_drawing_count: (a: number) => number;
    readonly aion_charts_end_selected_drawing_text_edit: (a: number, b: number) => number;
    readonly aion_charts_execution_mark_count: (a: number) => number;
    readonly aion_charts_expand_execution_cluster: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_export_drawings: (a: number) => [number, number];
    readonly aion_charts_export_image_data_url: (a: number) => [number, number, number, number];
    readonly aion_charts_export_pane_image_data_url: (a: number) => [number, number, number, number];
    readonly aion_charts_export_persistence_state: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_get_auto_scroll: (a: number) => number;
    readonly aion_charts_get_available_chart_types: () => [number, number];
    readonly aion_charts_get_chart_type: (a: number) => [number, number];
    readonly aion_charts_get_css_variables: (a: number) => any;
    readonly aion_charts_get_drawings_lock_summary_json: (a: number) => [number, number];
    readonly aion_charts_get_execution_label_mode: (a: number) => [number, number];
    readonly aion_charts_get_execution_mark_text_visible: (a: number) => number;
    readonly aion_charts_get_execution_marks_json: (a: number) => [number, number];
    readonly aion_charts_get_execution_pnl_visible: (a: number) => number;
    readonly aion_charts_get_footprint_xy_zoom_enabled: (a: number) => number;
    readonly aion_charts_get_order_lines_json: (a: number) => [number, number];
    readonly aion_charts_get_selected_drawing_info_json: (a: number) => [number, number];
    readonly aion_charts_get_selected_execution_mark: (a: number) => [number, number];
    readonly aion_charts_get_study_output: (a: number, b: number, c: number) => any;
    readonly aion_charts_get_supported_renderers: () => any;
    readonly aion_charts_get_volume_visible: (a: number) => number;
    readonly aion_charts_hit_test_marker: (a: number, b: number, c: number) => any;
    readonly aion_charts_import_drawings: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_import_persistence_state: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_indicator_attach: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_indicator_compile: (a: number, b: number, c: number, d: number, e: number) => any;
    readonly aion_charts_indicator_detach: (a: number, b: number) => number;
    readonly aion_charts_indicator_drain_events: (a: number) => any;
    readonly aion_charts_indicator_get_diagnostics: (a: number, b: number) => any;
    readonly aion_charts_indicator_get_mtf_requests: (a: number, b: number) => any;
    readonly aion_charts_indicator_get_stats: (a: number, b: number) => any;
    readonly aion_charts_indicator_list: (a: number) => any;
    readonly aion_charts_indicator_pane_count: (a: number) => number;
    readonly aion_charts_indicator_set_enabled: (a: number, b: number, c: number) => number;
    readonly aion_charts_indicator_set_inputs: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_indicator_set_mtf_snapshot: (a: number, b: number, c: number) => number;
    readonly aion_charts_indicator_set_resource_limits: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_interval: (a: number) => [number, number];
    readonly aion_charts_interval_change_locked: (a: number) => number;
    readonly aion_charts_is_auto_render: (a: number) => number;
    readonly aion_charts_is_interval_allowed: (a: number, b: number, c: number) => number;
    readonly aion_charts_marker_auto_scale: (a: number) => number;
    readonly aion_charts_marker_z_order: (a: number) => [number, number];
    readonly aion_charts_max_bars_per_load: (a: number) => number;
    readonly aion_charts_max_indicator_panes: (a: number) => number;
    readonly aion_charts_off: (a: number, b: number, c: number, d: any) => void;
    readonly aion_charts_on: (a: number, b: number, c: number, d: any) => void;
    readonly aion_charts_on_key_down: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly aion_charts_once: (a: number, b: number, c: number, d: any) => void;
    readonly aion_charts_order_line_count: (a: number) => number;
    readonly aion_charts_price_line_count: (a: number) => number;
    readonly aion_charts_project_point: (a: number, b: bigint, c: number) => any;
    readonly aion_charts_remove_all_scale_drawings: (a: number) => void;
    readonly aion_charts_remove_autoscale_contribution: (a: number, b: number) => number;
    readonly aion_charts_remove_execution_mark: (a: number, b: number, c: number) => number;
    readonly aion_charts_remove_indicator_pane: (a: number, b: number) => number;
    readonly aion_charts_remove_marker: (a: number, b: number, c: number) => number;
    readonly aion_charts_remove_order_line: (a: number, b: number, c: number) => number;
    readonly aion_charts_remove_order_lines_by_status: (a: number, b: number, c: number) => void;
    readonly aion_charts_remove_price_line: (a: number, b: number) => number;
    readonly aion_charts_remove_selected_drawing: (a: number) => void;
    readonly aion_charts_remove_series: (a: number, b: number) => number;
    readonly aion_charts_remove_study: (a: number, b: number) => number;
    readonly aion_charts_render: (a: number) => void;
    readonly aion_charts_renderer_name: (a: number) => [number, number];
    readonly aion_charts_replay_cutoff_bar: (a: number) => bigint;
    readonly aion_charts_replay_mode: (a: number) => number;
    readonly aion_charts_replay_options: (a: number) => any;
    readonly aion_charts_replay_playing: (a: number) => number;
    readonly aion_charts_replay_step_back: (a: number) => [number, number];
    readonly aion_charts_replay_step_forward: (a: number) => [number, number];
    readonly aion_charts_reset_viewport: (a: number, b: number, c: number) => void;
    readonly aion_charts_series_count: (a: number) => number;
    readonly aion_charts_set_all_drawings_locked: (a: number, b: number) => number;
    readonly aion_charts_set_allowed_intervals: (a: number, b: any) => [number, number];
    readonly aion_charts_set_auto_scroll: (a: number, b: number) => void;
    readonly aion_charts_set_axis_border_color: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_axis_border_visible: (a: number, b: number) => void;
    readonly aion_charts_set_axis_text_color: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_axis_ticks_visible: (a: number, b: number) => void;
    readonly aion_charts_set_background_color: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_bar_series_data: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number];
    readonly aion_charts_set_bar_width_ratio: (a: number, b: number) => void;
    readonly aion_charts_set_bearish_color: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
    readonly aion_charts_set_bullish_color: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
    readonly aion_charts_set_chart_type: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_crosshair_label_text_color: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_crosshair_label_visible: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_set_crosshair_line_color: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly aion_charts_set_crosshair_line_label_bg_color: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly aion_charts_set_crosshair_line_style: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_crosshair_line_visible: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_set_crosshair_line_width: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_set_crosshair_mode: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_crosshair_state: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
    readonly aion_charts_set_crosshair_sync_state: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    readonly aion_charts_set_data_arrays: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number];
    readonly aion_charts_set_data_with_footprint_arrays: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number) => [number, number];
    readonly aion_charts_set_data_with_footprint_json: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_set_drawing_tool: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_execution_cluster_threshold_px: (a: number, b: number) => void;
    readonly aion_charts_set_execution_label_mode: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_set_execution_mark_text_visible: (a: number, b: number) => void;
    readonly aion_charts_set_execution_marks: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_execution_marks_json: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_set_execution_pnl_visible: (a: number, b: number) => void;
    readonly aion_charts_set_font_family: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_font_size: (a: number, b: number) => void;
    readonly aion_charts_set_footprint_bar: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
    readonly aion_charts_set_footprint_data_arrays: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => [number, number];
    readonly aion_charts_set_footprint_data_json: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_set_footprint_display_mode: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_footprint_options: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_set_footprint_tick_size: (a: number, b: number) => void;
    readonly aion_charts_set_footprint_xy_zoom_enabled: (a: number, b: number) => void;
    readonly aion_charts_set_grid_color: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_histogram_data: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => [number, number];
    readonly aion_charts_set_interval: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_set_interval_change_locked: (a: number, b: number) => [number, number];
    readonly aion_charts_set_last_price_label_visible: (a: number, b: number) => void;
    readonly aion_charts_set_last_price_line_style: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_last_price_line_visible: (a: number, b: number) => void;
    readonly aion_charts_set_last_price_line_width: (a: number, b: number) => void;
    readonly aion_charts_set_marker_auto_scale: (a: number, b: number) => void;
    readonly aion_charts_set_marker_z_order: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_set_markers: (a: number, b: number, c: number, d: number) => [number, number];
    readonly aion_charts_set_max_bars_per_load: (a: number, b: number) => void;
    readonly aion_charts_set_max_indicator_panes: (a: number, b: number) => void;
    readonly aion_charts_set_order_line_filled_quantity: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_set_order_line_label_text_color: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
    readonly aion_charts_set_order_line_pnl: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_set_order_line_price: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_set_order_line_price_precision: (a: number, b: number) => void;
    readonly aion_charts_set_order_line_show_cancel_buttons: (a: number, b: number) => void;
    readonly aion_charts_set_order_line_status: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly aion_charts_set_order_line_visible: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_set_order_lines_json: (a: number, b: number, c: number) => [number, number];
    readonly aion_charts_set_price_line_label: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_set_price_line_price: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_price_line_visible: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_price_scale_margins: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_price_scale_mode: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_price_scale_tick_density: (a: number, b: number) => void;
    readonly aion_charts_set_replay_cutoff_bar: (a: number, b: number) => [number, number];
    readonly aion_charts_set_replay_mode: (a: number, b: number) => [number, number];
    readonly aion_charts_set_replay_options: (a: number, b: any) => [number, number];
    readonly aion_charts_set_replay_playing: (a: number, b: number) => void;
    readonly aion_charts_set_selected_drawing_locked: (a: number, b: number) => number;
    readonly aion_charts_set_selected_drawing_text: (a: number, b: number, c: number) => number;
    readonly aion_charts_set_selected_drawing_text_alignment: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly aion_charts_set_selected_drawing_text_style: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
    readonly aion_charts_set_selected_execution_mark: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_selected_fibonacci_levels_json: (a: number, b: number, c: number) => [number, number, number];
    readonly aion_charts_set_selected_rectangle_middle_line: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
    readonly aion_charts_set_selected_text_border: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
    readonly aion_charts_set_selected_text_fill: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly aion_charts_set_series_data: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    readonly aion_charts_set_series_visible: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_study_parameter: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_subpane_separator_color: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_subpane_separator_hit_area: (a: number, b: number) => void;
    readonly aion_charts_set_subpane_separator_hover_color: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly aion_charts_set_subpane_separator_thickness: (a: number, b: number) => void;
    readonly aion_charts_set_symbol: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_time_markers: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    readonly aion_charts_set_visible_range: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_volume_colors: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
    readonly aion_charts_set_volume_visible: (a: number, b: number) => void;
    readonly aion_charts_start_auto_render: (a: number) => void;
    readonly aion_charts_stop_auto_render: (a: number) => void;
    readonly aion_charts_study_count: (a: number) => number;
    readonly aion_charts_symbol: (a: number) => [number, number];
    readonly aion_charts_theme: (a: number) => [number, number];
    readonly aion_charts_tick_drawing_caret_blink: (a: number, b: number) => number;
    readonly aion_charts_timestamp_to_bar_index: (a: number, b: bigint) => bigint;
    readonly aion_charts_update_indicator_pane: (a: number, b: number, c: number) => void;
    readonly aion_charts_update_last_bar: (a: number, b: bigint, c: number, d: number, e: number, f: number, g: number) => [number, number];
    readonly aion_charts_update_last_bar_series_point: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number) => [number, number];
    readonly aion_charts_update_last_histogram_point: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number, h: number) => [number, number];
    readonly aion_charts_update_last_series_point: (a: number, b: number, c: bigint, d: number) => [number, number];
    readonly aion_charts_upsert_bar: (a: number, b: bigint, c: number, d: number, e: number, f: number, g: number) => [number, number];
    readonly aion_charts_upsert_bar_series_point: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number) => [number, number];
    readonly aion_charts_upsert_bar_with_footprint: (a: number, b: bigint, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number];
    readonly aion_charts_upsert_bars: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number];
    readonly aion_charts_upsert_histogram_point: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number, h: number) => [number, number];
    readonly aion_charts_upsert_series_point: (a: number, b: number, c: bigint, d: number) => [number, number];
    readonly aion_charts_visible_range: (a: number) => [number, number];
    readonly aion_charts_zoom_to_range: (a: number, b: bigint, c: bigint) => void;
    ...
    readonly chartgroup_pane_data_range: (a: number, b: number) => [number, number];
    readonly chartgroup_pane_interval: (a: number, b: number) => [number, number];
    readonly chartgroup_pane_symbol: (a: number, b: number) => [number, number];
    readonly chartgroup_pane_time_range: (a: number, b: number) => [number, number];
    readonly chartgroup_remove_pane: (a: number, b: number) => number;
    readonly chartgroup_set_auto_link: (a: number, b: number) => void;
    readonly chartgroup_set_sync: (a: number, b: number, c: number, d: number) => [number, number];
    readonly chartgroup_set_sync_for_link: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
    readonly chartgroup_set_sync_for_pane: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly chartgroup_unlink_panes: (a: number, b: number, c: number) => number;
    readonly chartgroup_update_crosshair: (a: number, b: number, c: number, d: number) => any;
    readonly chartgroup_update_data_range: (a: number, b: number, c: number, d: number) => any;
    readonly chartgroup_update_interval: (a: number, b: number, c: number, d: number) => any;
    readonly chartgroup_update_symbol: (a: number, b: number, c: number, d: number) => any;
    readonly chartgroup_update_time_range: (a: number, b: number, c: number, d: number) => any;
    readonly indicatorworkerruntime_attach: (a: number, b: number, c: number, d: number) => number;
    readonly indicatorworkerruntime_compile: (a: number, b: number, c: number, d: number, e: number) => any;
    readonly indicatorworkerruntime_drain_events_json: (a: number) => [number, number];
    readonly indicatorworkerruntime_draw_instructions_json: (a: number) => [number, number];
    ...
    readonly indicatorworkerruntime_set_data_arrays: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number];
    readonly indicatorworkerruntime_upsert_bar: (a: number, b: bigint, c: number, d: number, e: number, f: number, g: number) => [number, number];
    readonly wasm_bindgen__closure__destroy__h09ff9d2157ef0cac: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h7189099d4ae87eba: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h7786fa800d11f20a: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h92d277a9e73a8830: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__ha5b9bd6f60d810f0: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h54b5ec4e5daa0037: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h0711f49dfcf70ac6: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__hc9bffe6cb7397f36: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h244aa4cacbfb7934: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h160af521f7969f79: (a: number, b: number, c: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2e4f7e4bbddf86e9: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h18aee172ef939116: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5b0fed36bfe92046: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h2a4c4588e55deacf: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0894089cb9abe05b: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hfb83aab43a7a8ff3: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h624940a946cabd68: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h9c76fb0acc9e105b: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hf263c0e6d31821ed: (a: number, b: number) => number;
    readonly wasm_bindgen__convert__closures_____invoke__hffdacf2875d1a35e: (a: number, b: number) => void;
