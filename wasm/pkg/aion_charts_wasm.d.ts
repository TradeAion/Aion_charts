...
export interface InitOutput {
    ...
    readonly aion_charts_add_marker: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number) => void;
    readonly aion_charts_add_marker_at_time: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number) => void;
    ...
    readonly aion_charts_create_chart: (a: number, b: number) => number;
    readonly aion_charts_create_order_line: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => void;
    readonly aion_charts_create_order_line_full: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number, w: number) => void;
    ...
    readonly aion_charts_create_with: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_crosshair_mode: (a: number, b: number) => void;
    readonly aion_charts_crosshair_state: (a: number, b: number) => void;
    readonly aion_charts_data_range: (a: number, b: number) => void;
    ...
    readonly aion_charts_get_chart_type: (a: number, b: number) => void;
    readonly aion_charts_get_css_variables: (a: number) => number;
    readonly aion_charts_get_drawings_lock_summary_json: (a: number, b: number) => void;
    readonly aion_charts_get_execution_label_mode: (a: number, b: number) => void;
    readonly aion_charts_get_execution_mark_text_visible: (a: number) => number;
    readonly aion_charts_get_execution_marks_json: (a: number, b: number) => void;
    ...
    readonly aion_charts_get_order_lines_json: (a: number, b: number) => void;
    readonly aion_charts_get_selected_drawing_info_json: (a: number, b: number) => void;
    readonly aion_charts_get_selected_execution_mark: (a: number, b: number) => void;
    readonly aion_charts_get_study_output: (a: number, b: number, c: number) => number;
    readonly aion_charts_get_supported_renderers: () => number;
    readonly aion_charts_get_volume_visible: (a: number) => number;
    readonly aion_charts_hit_test_marker: (a: number, b: number, c: number) => number;
    readonly aion_charts_import_drawings: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_import_persistence_state: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_indicator_attach: (a: number, b: number, c: number, d: number) => number;
    readonly aion_charts_indicator_compile: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly aion_charts_indicator_detach: (a: number, b: number) => number;
    readonly aion_charts_indicator_drain_events: (a: number) => number;
    readonly aion_charts_indicator_get_diagnostics: (a: number, b: number) => number;
    readonly aion_charts_indicator_get_mtf_requests: (a: number, b: number) => number;
    readonly aion_charts_indicator_get_stats: (a: number, b: number) => number;
    readonly aion_charts_indicator_list: (a: number) => number;
    ...
    readonly aion_charts_interval: (a: number, b: number) => void;
    ...
    readonly aion_charts_marker_z_order: (a: number, b: number) => void;
    readonly aion_charts_max_bars_per_load: (a: number) => number;
    readonly aion_charts_max_indicator_panes: (a: number) => number;
    readonly aion_charts_off: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_on: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_on_key_down: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
    readonly aion_charts_once: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_order_line_count: (a: number) => number;
    readonly aion_charts_price_line_count: (a: number) => number;
    readonly aion_charts_project_point: (a: number, b: bigint, c: number) => number;
    ...
    readonly aion_charts_renderer_name: (a: number, b: number) => void;
    readonly aion_charts_replay_cutoff_bar: (a: number) => bigint;
    readonly aion_charts_replay_mode: (a: number) => number;
    readonly aion_charts_replay_options: (a: number) => number;
    readonly aion_charts_replay_playing: (a: number) => number;
    readonly aion_charts_replay_step_back: (a: number, b: number) => void;
    readonly aion_charts_replay_step_forward: (a: number, b: number) => void;
    ...
    readonly aion_charts_set_allowed_intervals: (a: number, b: number, c: number) => void;
    ...
    readonly aion_charts_set_bar_series_data: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => void;
    ...
    readonly aion_charts_set_data_arrays: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number) => void;
    readonly aion_charts_set_data_with_footprint_arrays: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number, t: number, u: number, v: number) => void;
    readonly aion_charts_set_data_with_footprint_json: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly aion_charts_set_execution_label_mode: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly aion_charts_set_execution_marks_json: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly aion_charts_set_footprint_bar: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => void;
    readonly aion_charts_set_footprint_data_arrays: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => void;
    readonly aion_charts_set_footprint_data_json: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_set_footprint_display_mode: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_footprint_options: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly aion_charts_set_histogram_data: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => void;
    readonly aion_charts_set_interval: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_set_interval_change_locked: (a: number, b: number, c: number) => void;
    ...
    readonly aion_charts_set_marker_z_order: (a: number, b: number, c: number, d: number) => void;
    readonly aion_charts_set_markers: (a: number, b: number, c: number, d: number, e: number) => void;
    ...
    readonly aion_charts_set_order_lines_json: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly aion_charts_set_replay_cutoff_bar: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_replay_mode: (a: number, b: number, c: number) => void;
    readonly aion_charts_set_replay_options: (a: number, b: number, c: number) => void;
    ...
    readonly aion_charts_set_selected_fibonacci_levels_json: (a: number, b: number, c: number, d: number) => void;
    ...
    readonly aion_charts_set_series_data: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    ...
    readonly aion_charts_set_time_markers: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    ...
    readonly aion_charts_symbol: (a: number, b: number) => void;
    readonly aion_charts_theme: (a: number, b: number) => void;
    ...
    readonly aion_charts_update_last_bar: (a: number, b: number, c: bigint, d: number, e: number, f: number, g: number, h: number) => void;
    readonly aion_charts_update_last_bar_series_point: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number, h: number) => void;
    readonly aion_charts_update_last_histogram_point: (a: number, b: number, c: number, d: bigint, e: number, f: number, g: number, h: number, i: number) => void;
    readonly aion_charts_update_last_series_point: (a: number, b: number, c: number, d: bigint, e: number) => void;
