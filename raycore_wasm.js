/* @ts-self-types="./raycore_wasm.d.ts" */

export class RayCore {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(RayCore.prototype);
        obj.__wbg_ptr = ptr;
        RayCoreFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        RayCoreFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    static create_with(container_id, renderer) {
        ...
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.raycore_create_with(ptr0, len0, ptr1, len1);
        return takeObject(ret);
    }
    demo_mode() {
     ...
     */
    render() {
        wasm.raycore_render(this.__wbg_ptr);
    }
    /**
     * @returns {string}
     */
    renderer_name() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.raycore_renderer_name(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    set_data(data) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.raycore_set_data(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {Float32Array} open
     * @param {Float32Array} high
    ...
    set_data_arrays(open, high, low, close, volume, timestamps) {
        const ptr0 = passArrayF32ToWasm0(open, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(high, wasm.__wbindgen_export);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passArrayF32ToWasm0(low, wasm.__wbindgen_export);
        const len2 = WASM_VECTOR_LEN;
        const ptr3 = passArrayF32ToWasm0(close, wasm.__wbindgen_export);
        const len3 = WASM_VECTOR_LEN;
        const ptr4 = passArrayF32ToWasm0(volume, wasm.__wbindgen_export);
        const len4 = WASM_VECTOR_LEN;
    ...
    visible_range() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.raycore_visible_range(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
    ...
    zoom_to_range(start, end) {
        wasm.raycore_zoom_to_range(this.__wbg_ptr, start, end);
    }
}
if (Symbol.dispose) RayCore.prototype[Symbol.dispose] = RayCore.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_raycore_new: function(arg0) {
            const ret = RayCore.__wrap(arg0);
            return addHeapObject(ret);
        },
...
const RayCoreFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_raycore_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('raycore_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
