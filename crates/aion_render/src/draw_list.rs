...
pub enum Prim {
    ...
    RectFrame { rect: IRect, border: i32, color: Color },
    /// Full-length 1px-class horizontal line at integer y (with half-pixel handling in backend).
    HLine { y: i32, x0: i32, x1: i32, width: i32, style: LineStyle, color: Color },
    VLine { x: i32, y0: i32, y1: i32, width: i32, style: LineStyle, color: Color },
    ...
    Text { run_id: u32, x: f32, y: f32, color: Color },
}
